...
public class Account {
    ...
    public void transfer(Account acc1 , Account acc2 , double amt) throws MinimumBalanceException {

        if(acc2.balance<500){
                throw new MinimumBalanceException("Value cannot be less than 500");
        }
        else if(acc2.balance-amt<500){
                throw new MinimumBalanceException("Account Balance cannot go do down from the limit!!");
        }
        else{
